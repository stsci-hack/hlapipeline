...
def slFiles2dataTables(slNames):
    ...
    * Flag Value
    ...
    titleSwapDict_dao={"X":"X-Center","Y":"Y-Center","RA":"RA","DEC":"DEC","FLUX1":"n/a","FLUX2":"Flux(0.15)","MAGNITUDE1":"MagAp(0.05)","MAGNITUDE2":"MagAp(0.15)","MERR1":"MagErr(0.05)","MERR2":"MagErr(0.15)","MSKY":"MSky(0.15)","STDEV":"Stdev(0.15)","FLAGS":"Flags","ID":"ID","CI":"CI"}
    ...
    for dataTable in [refData_in,compData_in]:
        if "X-Center" in dataTable.keys():
            print "titleSwapDict_dao"
            titleSwapDict = titleSwapDict_dao
